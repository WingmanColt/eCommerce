...
namespace HireMe.StoredProcedures.Services
{
    public class spOrder : IspOrder
    {
        ...
        public async Task<OperationResult> CRUD(object parameters, ActionEnum action, bool AutoFindParams, string skipAttribute, User user)
        {
            ...
            if (AutoFindParams)
            {
                ...
                entity.Update((OrderInput)parameters, user);
