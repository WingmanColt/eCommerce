...
import { ProductListing, Products, Images, Variants } from '../../../shared/classes/product';
...
export class CollectionInfinitescrollComponent implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute, private router: Router,
    private viewScroller: ViewportScroller, public productService: ProductsService) {   
      // Get Query params..
      this.route.queryParams.subscribe(params => {
        ...
        this.sortBy = params.sortBy ? params.sortBy : 'ascending';
          ...
          this.g_Subs = this.productService.products().subscribe((response) => {
          ...
          // Category Filter
          if(params.category)
            this.all_products = this.all_products.filter(item => item.categoryId == this.categoryId);
